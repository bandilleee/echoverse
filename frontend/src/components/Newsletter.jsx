...
const Newsletter = () => {
  return (
    <div className='flex flex-col items-center justify-center text-center space-y-2 my-32'>
        ...
        <p className='md:text-lg text-lg text-gray-500/70 pb-8'>
            Let the best echoes find you first. Fresh voices, emerging tech, 
            and stories that linger long after reading.
        </p>
