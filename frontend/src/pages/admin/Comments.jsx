...
const Comments = () => {
  ...
  return (
    <div className='flex-1 pt-5 px-5 sm:px-12 sm:pl-16 bg-blue-50/50'>
        ...
        <div className='relative h-4/5 max-w-3xl overflow-x-auto mt-4 bg-white shadow rounded scrollbar-hide'>
